...
struct sDoWhileNode {int sline; char* sname  ; int sline_real; struct sNode* mExpressionNode; struct sBlock* mBlock  ; };
...
struct sDoWhileNode* sDoWhileNode_initialize(struct sDoWhileNode* self, struct sNode* expression_node, struct sBlock* block  , struct sInfo* info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sDoWhileNode_initialize"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct sNode* __dec_obj1;
    struct sBlock* __dec_obj46  ;
    struct sDoWhileNode* __result_obj__0;
    ((struct sNodeBase*)(__right_value0=sNodeBase_initialize((struct sDoWhileNode*)come_increment_ref_count(self),info)));
...
_Bool sDoWhileNode_terminated(struct sDoWhileNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sDoWhileNode_terminated"; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
    return (_Bool)1;
    neo_current_frame = fr.prev;
}
...
char* sDoWhileNode_kind(struct sDoWhileNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sDoWhileNode_kind"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
...
_Bool sDoWhileNode_compile(struct sDoWhileNode* self, struct sInfo* info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sDoWhileNode_compile"; neo_current_frame = &fr;
    struct sBlock* block  ;
...
static void sDoWhileNode_finalize(struct sDoWhileNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sDoWhileNode_finalize"; neo_current_frame = &fr;
    if(self!=((void*)0)&&self->sname!=((void*)0)) {
        (self->sname = come_decrement_ref_count(self->sname, (void*)0, (void*)0, 0, 0, (void*)0));
    }
...
struct sNode* string_node_v10(char* buf, char* head, int head_sline, struct sInfo* info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "string_node_v10"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    char* sname  ;
    int sline;
    struct sBlock* block  ;
    ...
    if(charp_operator_equals(buf,"do")) {
        sname=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "17do_while.nc", 55, "char*"));
        sline=info->sline;
        ...
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 74, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value1=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), (void*)0, 74, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node),block,info))));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sDoWhileNode_clone"; neo_current_frame = &fr;
    struct sDoWhileNode* __result_obj__0;
    void* __right_value0 = (void*)0;
    ...
    result=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), (void*)0, 3, "struct sDoWhileNode*"));
    if(self!=((void*)0)) {
        result->sline=self->sline;
    }
    if(self!=((void*)0)&&self->sname!=((void*)0)) {
    ...
    if(self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj48=result->mExpressionNode,
