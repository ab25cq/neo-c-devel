...
struct sForNode {int sline; char* sname  ; int sline_real; struct sNode* mExpressionNode; struct sNode* mExpressionNode2; struct sNode* mExpressionNode3; struct sBlock* mBlock  ; };
...
static struct sType* sType_clone(struct sType* self  )
{
    ...
    if(self!=((void*)0)&&self->mTypeOfNodeValue!=((void*)0)) {
        __dec_obj46=result->mTypeOfNodeValue,
