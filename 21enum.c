...
struct sEnumNode {int sline; char* sname  ; int sline_real; char* mTypeName  ; };
...
void output_enum(char* type_name  , struct sInfo* info  );
...
struct sEnumNode* sEnumNode_initialize(struct sEnumNode* self, char* type_name  , struct sInfo* info  );
...
char* make_enum(struct sClass* klass  , struct sInfo* info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "make_enum"; neo_current_frame = &fr;
    char* type_name  ;
...
;    char* name  =0;
    ...
    type_name=(char*)come_increment_ref_count(klass->mName);
    elements=klass->mElements;
    type_elements=(struct sType*)come_increment_ref_count(klass->mTypeElements);
    attribute=(char*)come_increment_ref_count(klass->mAttribute);
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), (void*)0, 16, "struct buffer*"))));
    if(type_elements) {
        buffer_append_format(buf,"enum %s %s:%s { ",attribute,type_name,((char*)(__right_value0=make_type_name_string(type_elements,info,(_Bool)0,(_Bool)0,(_Bool)0))));
    ...
    for(o2_saved=elements,it=list$1tuple3$3char$phsNode$phchar$ph$ph_begin(o2_saved);!list$1tuple3$3char$phsNode$phchar$ph$ph_end(o2_saved);it=list$1tuple3$3char$phsNode$phchar$ph$ph_next(o2_saved)){
        ...
        attribute_2=(char*)come_increment_ref_count(multiple_assign_var1->v3);
        if(value==((void*)0)) {
            buffer_append_str(buf,name);
            buffer_append_str(buf," ");
            buffer_append_str(buf,attribute_2);
            ...
            add_variable_to_global_table_with_int_value(name,((struct sType*)(__right_value2=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 62, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),(_Bool)0,info,(_Bool)0))),c_value,info);
            ...
            if(!Value) {
                ...
                (attribute_2 = come_decrement_ref_count(attribute_2, (void*)0, (void*)0, 0, 0, (void*)0));
            ...
            c_value_3=(char*)come_increment_ref_count(xsprintf("(%s)",right_value->c_value));
            add_variable_to_global_table_with_int_value(name,((struct sType*)(__right_value2=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 73, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),(_Bool)0,info,(_Bool)0))),c_value_3,info);
            come_call_finalizer(sType_finalize, __right_value2, (void*)0, (void*)0, 0, 1, 0, (void*)0);
            buffer_append_format(buf,"%s=(%s)",name,right_value->c_value);
            if(i!=list$1tuple3$3char$phsNode$phchar$ph$ph_length(elements)-1) {
                buffer_append_str(buf,",");
            }
            __dec_obj3=right_c_value,
            right_c_value=(char*)come_increment_ref_count((char*)come_memdup(right_value->c_value, "21enum.nc", 81, "char*"));
            ...
            (c_value_3 = come_decrement_ref_count(c_value_3, (void*)0, (void*)0, 0, 0, (void*)0));
        }
        i++;
        n++;
        (name = come_decrement_ref_count(name, (void*)0, (void*)0, 0, 0, (void*)0));
...
static struct tuple3$3char$phsNode$phchar$ph* list$1tuple3$3char$phsNode$phchar$ph$ph_begin(struct list$1tuple3$3char$phsNode$phchar$ph$ph* self)
{
    ...
    struct tuple3$3char$phsNode$phchar$ph* result_0;
    if(self==((void*)0)) {
    ...
    memset(&result_0,0,sizeof(struct tuple3$3char$phsNode$phchar$ph*));
...
static struct tuple3$3char$phsNode$phchar$ph* list$1tuple3$3char$phsNode$phchar$ph$ph_next(struct list$1tuple3$3char$phsNode$phchar$ph$ph* self)
{
    ...
    struct tuple3$3char$phsNode$phchar$ph* result;
    struct tuple3$3char$phsNode$phchar$ph* __result_obj__0;
    struct tuple3$3char$phsNode$phchar$ph* result_1;
    ...
    memset(&result_1,0,sizeof(struct tuple3$3char$phsNode$phchar$ph*));
...
void output_enum(char* type_name  , struct sInfo* info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "output_enum"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct sClass* klass  ;
    char* output  ;
    char* __dec_obj4  ;
...
;    struct buffer* d  =0;
    ...
    output=(char*)come_increment_ref_count(make_enum(klass,info));
    __dec_obj4=output,
    output=(char*)come_increment_ref_count(string_operator_add(output,";/* b */\n"));
    __dec_obj4 = come_decrement_ref_count(__dec_obj4, (void*)0, (void*)0, 0,0, (void*)0);
    if(({(_conditional_value_X0=(((struct tuple2$2buffer$phbuffer$ph*)(__right_value2=map$2char$phtuple2$2buffer$phbuffer$ph$ph_operator_load_element(info->struct_definition,((char*)(__right_value1=__builtin_string(type_name))))))==((void*)0)));    (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
    come_call_finalizer(tuple2$2buffer$phbuffer$ph$p_finalize, __right_value2, (void*)0, (void*)0, 0, 1, 0, (void*)0);
_conditional_value_X0;})) {
        map$2char$phtuple2$2buffer$phbuffer$ph$ph_insert(info->struct_definition,(char*)come_increment_ref_count(__builtin_string(type_name)),(struct tuple2$2buffer$phbuffer$ph*)come_increment_ref_count(tuple2$2buffer$phbuffer$ph_initialize((struct tuple2$2buffer$phbuffer$ph*)come_increment_ref_count((struct tuple2$2buffer$phbuffer$ph*)come_calloc(1, sizeof(struct tuple2$2buffer$phbuffer$ph)*(1), "21enum.nc", 103, "struct tuple2$2buffer$phbuffer$ph")),(struct buffer*)come_increment_ref_count(charp_to_buffer(output)),(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), (void*)0, 103, "struct buffer*")))))),(_Bool)0);
    }
    else if(({(_conditional_value_X1=(((struct tuple2$2buffer$phbuffer$ph*)(__right_value2=map$2char$phtuple2$2buffer$phbuffer$ph$ph_operator_load_element(info->struct_definition,((char*)(__right_value1=__builtin_string(type_name))))))&&string_operator_equals(((char*)(__right_value10=buffer_to_string(((struct tuple2$2buffer$phbuffer$ph*)(__right_value9=map$2char$phtuple2$2buffer$phbuffer$ph$ph_operator_load_element(info->struct_definition,((char*)(__right_value8=__builtin_string(type_name))))))->v1))),"")));    (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
    come_call_finalizer(tuple2$2buffer$phbuffer$ph$p_finalize, __right_value2, (void*)0, (void*)0, 0, 1, 0, (void*)0);
...
_conditional_value_X1;})) {
        ...
        come_call_finalizer(tuple2$2buffer$phbuffer$ph$p_finalize, __right_value2, (void*)0, (void*)0, 0, 1, 0, (void*)0);
        map$2char$phtuple2$2buffer$phbuffer$ph$ph_insert(info->struct_definition,(char*)come_increment_ref_count(__builtin_string(type_name)),(struct tuple2$2buffer$phbuffer$ph*)come_increment_ref_count(tuple2$2buffer$phbuffer$ph_initialize((struct tuple2$2buffer$phbuffer$ph*)come_increment_ref_count((struct tuple2$2buffer$phbuffer$ph*)come_calloc(1, sizeof(struct tuple2$2buffer$phbuffer$ph)*(1), "21enum.nc", 109, "struct tuple2$2buffer$phbuffer$ph")),(struct buffer*)come_increment_ref_count(charp_to_buffer(output)),(struct buffer*)come_increment_ref_count(d2))),(_Bool)0);
...
static void map$2char$phtuple2$2buffer$phbuffer$ph$ph_rehash(struct map$2char$phtuple2$2buffer$phbuffer$ph$ph* self)
{
    ...
    unsigned int hash;
    int n;
    struct tuple2$2buffer$phbuffer$ph* default_value_6;
    size=self->size*10;
    ...
    for(it=map$2char$phtuple2$2buffer$phbuffer$ph$ph_begin(self);!map$2char$phtuple2$2buffer$phbuffer$ph$ph_end(self);it=map$2char$phtuple2$2buffer$phbuffer$ph$ph_next(self)){
        ...
        while((_Bool)1) {
            if(item_existance[n]) {
                ...
                keys[n]=it;
                memset(&default_value_6,0,sizeof(struct tuple2$2buffer$phbuffer$ph*));
                items[n]=((struct tuple2$2buffer$phbuffer$ph*)(__right_value0=map$2char$phtuple2$2buffer$phbuffer$ph$ph_at(self,it,(struct tuple2$2buffer$phbuffer$ph*)come_increment_ref_count(default_value_6),(_Bool)0)));
                len++;
                come_call_finalizer(tuple2$2buffer$phbuffer$ph$p_finalize, default_value_6, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                break;
                come_call_finalizer(tuple2$2buffer$phbuffer$ph$p_finalize, default_value_6, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            }
        }
...
static struct list$1char$ph* list$1char$ph_push_back(struct list$1char$ph* self, char* item  )
{
    ...
    if(self->len==0) {
        ...
        litem_15=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), (void*)0, 709, "struct list_item$1char$ph*"))));
        litem_15->prev=self->head;
        litem_15->next=((void*)0);
        __dec_obj6=litem_15->item,
        ...
        litem_16=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), (void*)0, 719, "struct list_item$1char$ph*"))));
...
_Bool sEnumNode_compile(struct sEnumNode* self, struct sInfo* info  )
{
    ...
    come_call_finalizer(tuple2$2buffer$phbuffer$ph$p_finalize, __right_value2, (void*)0, (void*)0, 0, 1, 0, (void*)0);
_conditional_value_X0;})) {
        output_enum((char*)come_increment_ref_count(type_name),info);
    }
...
struct sNode* parse_enum(char* type_name  , char* attribute  , struct sInfo* info  , _Bool anonymous)
{
    ...
    void* __right_value1 = (void*)0;
    void* __right_value2 = (void*)0;
    struct sClass* __dec_obj11  ;
    struct sClass* __dec_obj12  ;
...
;    struct sType* type  =0;
    ...
    void* __right_value6 = (void*)0;
    char* attribute2  ;
    struct list$1tuple3$3char$phsNode$phchar$ph$ph* __dec_obj26;
    char* __dec_obj27  ;
...
_conditional_value_X0;})) {
        __dec_obj11=klass,
        klass=(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), (void*)0, 150, "struct sClass*")),((char*)(__right_value1=__builtin_string(type_name))),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)1,(_Bool)0,(_Bool)0,info));
        come_call_finalizer(sClass_finalize, __dec_obj11,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        come_call_finalizer(sClass_finalize, __dec_obj12,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(!klass->mEnum) {
    ...
    if(*info->p==58) {
        ...
        __dec_obj13=klass->mTypeElements,
        klass->mTypeElements=(struct sType*)come_increment_ref_count(type);
    ...
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    elements=(struct list$1tuple3$3char$phsNode$phchar$ph$ph*)come_increment_ref_count(list$1tuple3$3char$phsNode$phchar$ph$ph_initialize((struct list$1tuple3$3char$phsNode$phchar$ph$ph*)come_increment_ref_count((struct list$1tuple3$3char$phsNode$phchar$ph$ph*)come_calloc(1, sizeof(struct list$1tuple3$3char$phsNode$phchar$ph$ph)*(1), (void*)0, 174, "struct list$1tuple3$3char$phsNode$phchar$ph$ph*"))));
    while((_Bool)1) {
        if(*info->p==125) {
            info->p++;
            skip_spaces_and_lf(info);
        ...
        attribute_20=(char*)come_increment_ref_count(parse_struct_attribute(info));
        if(*info->p==61&&*(info->p+1)!=61) {
            ...
            list$1tuple3$3char$phsNode$phchar$ph$ph_push_back(elements,(struct tuple3$3char$phsNode$phchar$ph*)come_increment_ref_count(tuple3$3char$phsNode$phchar$ph_initialize((struct tuple3$3char$phsNode$phchar$ph*)come_increment_ref_count((struct tuple3$3char$phsNode$phchar$ph*)come_calloc(1, sizeof(struct tuple3$3char$phsNode$phchar$ph)*(1), "21enum.nc", 201, "struct tuple3$3char$phsNode$phchar$ph")),(char*)come_increment_ref_count(element_name),(struct sNode*)come_increment_ref_count(element_value),(char*)come_increment_ref_count(attribute_20))));
            ...
            list$1tuple3$3char$phsNode$phchar$ph$ph_push_back(elements,(struct tuple3$3char$phsNode$phchar$ph*)come_increment_ref_count(tuple3$3char$phsNode$phchar$ph_initialize((struct tuple3$3char$phsNode$phchar$ph*)come_increment_ref_count((struct tuple3$3char$phsNode$phchar$ph*)come_calloc(1, sizeof(struct tuple3$3char$phsNode$phchar$ph)*(1), "21enum.nc", 204, "struct tuple3$3char$phsNode$phchar$ph")),(char*)come_increment_ref_count(element_name),(struct sNode*)come_increment_ref_count((struct sNode*)((void*)0)),(char*)come_increment_ref_count(attribute_20))));
        }
        ((char*)(__right_value0=parse_struct_attribute(info)));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        if(*info->p==44) {
        ...
        if(*info->p==125) {
            ...
            (attribute_20 = come_decrement_ref_count(attribute_20, (void*)0, (void*)0, 0, 0, (void*)0));
            break;
        }
        (element_name = come_decrement_ref_count(element_name, (void*)0, (void*)0, 0, 0, (void*)0));
        (attribute_20 = come_decrement_ref_count(attribute_20, (void*)0, (void*)0, 0, 0, (void*)0));
    ...
    __dec_obj26=klass->mElements,
    klass->mElements=(struct list$1tuple3$3char$phsNode$phchar$ph$ph*)come_increment_ref_count(list$1tuple3$3char$phsNode$phchar$ph$ph$p_clone(elements));
    come_call_finalizer(list$1tuple3$3char$phsNode$phchar$ph$ph_finalize, __dec_obj26,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __dec_obj27=klass->mAttribute,
    klass->mAttribute=(char*)come_increment_ref_count(attribute2);
    __dec_obj27 = come_decrement_ref_count(__dec_obj27, (void*)0, (void*)0, 0,0, (void*)0);
    _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 228, "struct sNode");
    _inf_obj_value1=(struct sEnumNode*)come_increment_ref_count(((struct sEnumNode*)(__right_value1=sEnumNode_initialize((struct sEnumNode*)come_increment_ref_count((struct sEnumNode*)come_calloc(1, sizeof(struct sEnumNode)*(1), (void*)0, 228, "struct sEnumNode*")),(char*)come_increment_ref_count(type_name),info))));
...
static void map$2char$phsClass$ph_rehash(struct map$2char$phsClass$ph* self)
{
    ...
    unsigned int hash;
    int n;
    struct sClass* default_value_19  ;
    size=self->size*10;
    keys=(char**)come_increment_ref_count(((char**)(__right_value0=(char**)come_calloc(1, sizeof(char*)*(1*(size)), (void*)0, 1865, "char**"))));
    ...
    for(it=map$2char$phsClass$ph_begin(self);!map$2char$phsClass$ph_end(self);it=map$2char$phsClass$ph_next(self)){
        ...
        while((_Bool)1) {
            if(item_existance[n]) {
                ...
                item_existance[n]=(_Bool)1;
                keys[n]=it;
                memset(&default_value_19,0,sizeof(struct sClass*));
                items[n]=((struct sClass*)(__right_value0=map$2char$phsClass$ph_at(self,it,(struct sClass*)come_increment_ref_count(default_value_19),(_Bool)0)));
                len++;
                come_call_finalizer(sClass_finalize, default_value_19, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                break;
                come_call_finalizer(sClass_finalize, default_value_19, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            }
        }
...
static struct list$1tuple3$3char$phsNode$phchar$ph$ph* list$1tuple3$3char$phsNode$phchar$ph$ph_push_back(struct list$1tuple3$3char$phsNode$phchar$ph$ph* self, struct tuple3$3char$phsNode$phchar$ph* item)
{
    ...
    struct tuple3$3char$phsNode$phchar$ph* __dec_obj14;
    struct list_item$1tuple3$3char$phsNode$phchar$ph$ph* litem_21;
    struct tuple3$3char$phsNode$phchar$ph* __dec_obj15;
    struct list_item$1tuple3$3char$phsNode$phchar$ph$ph* litem_22;
    struct tuple3$3char$phsNode$phchar$ph* __dec_obj16;
    if(self==((void*)0)) {
        __result_obj__0 = self;
    ...
    if(self->len==0) {
        litem=(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph)*(1), (void*)0, 699, "struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        __dec_obj14=litem->item,
        litem->item=(struct tuple3$3char$phsNode$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple3$3char$phsNode$phchar$ph$p_finalize, __dec_obj14,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        self->tail=litem;
        self->head=litem;
    }
    else if(self->len==1) {
        litem_21=(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph)*(1), (void*)0, 709, "struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*"))));
        litem_21->prev=self->head;
        litem_21->next=((void*)0);
        __dec_obj15=litem_21->item,
        litem_21->item=(struct tuple3$3char$phsNode$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple3$3char$phsNode$phchar$ph$p_finalize, __dec_obj15,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        self->tail=litem_21;
        self->head->next=litem_21;
    }
    else {
        litem_22=(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph)*(1), (void*)0, 719, "struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*"))));
        litem_22->prev=self->tail;
        litem_22->next=((void*)0);
        __dec_obj16=litem_22->item,
        litem_22->item=(struct tuple3$3char$phsNode$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple3$3char$phsNode$phchar$ph$p_finalize, __dec_obj16,(void*)0, (void*)0, 0, 0, 0, (void*)0);
...
static struct list$1tuple3$3char$phsNode$phchar$ph$ph* list$1tuple3$3char$phsNode$phchar$ph$ph_add(struct list$1tuple3$3char$phsNode$phchar$ph$ph* self, struct tuple3$3char$phsNode$phchar$ph* item)
{
    ...
    void* __right_value0 = (void*)0;
    struct list_item$1tuple3$3char$phsNode$phchar$ph$ph* litem;
    struct tuple3$3char$phsNode$phchar$ph* __dec_obj20;
    ...
    if(self->len==0) {
        ...
        litem->item=(struct tuple3$3char$phsNode$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple3$3char$phsNode$phchar$ph$p_finalize, __dec_obj20,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        self->tail=litem;
        self->head=litem;
    }
    else if(self->len==1) {
        litem_23=(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph)*(1), (void*)0, 624, "struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*"))));
        litem_23->prev=self->head;
        litem_23->next=((void*)0);
        __dec_obj21=litem_23->item,
        litem_23->item=(struct tuple3$3char$phsNode$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple3$3char$phsNode$phchar$ph$p_finalize, __dec_obj21,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        self->tail=litem_23;
        self->head->next=litem_23;
    }
    else {
        litem_24=(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple3$3char$phsNode$phchar$ph$ph)*(1), (void*)0, 634, "struct list_item$1tuple3$3char$phsNode$phchar$ph$ph*"))));
        litem_24->prev=self->tail;
        litem_24->next=((void*)0);
        __dec_obj22=litem_24->item,
        litem_24->item=(struct tuple3$3char$phsNode$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple3$3char$phsNode$phchar$ph$p_finalize, __dec_obj22,(void*)0, (void*)0, 0, 0, 0, (void*)0);
...
;    struct sType* type  =0;
    ...
    if(charp_operator_equals(buf,"enum")) {
        ...
        if(xisalpha(*info->p)||*info->p==95) {
            ...
            static int n=0;
            __dec_obj32=type_name,
            type_name=(char*)come_increment_ref_count(xsprintf("__anoymous_enum_top\%s",((char*)(__right_value0=int_to_string(n++)))));
            __dec_obj32 = come_decrement_ref_count(__dec_obj32, (void*)0, (void*)0, 0,0, (void*)0);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            anonymous=(_Bool)1;
        }
        __result_obj__0 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value0=parse_enum((char*)come_increment_ref_count(type_name),(char*)come_increment_ref_count(attribute),info,anonymous))));
        (type_name = come_decrement_ref_count(type_name, (void*)0, (void*)0, 0, 0, (void*)0));
        come_call_finalizer(sType_finalize, type_elements, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        (attribute = come_decrement_ref_count(attribute, (void*)0, (void*)0, 0, 0, (void*)0));
...
struct sNode* string_node_v16(char* buf, char* head, int head_sline, struct sInfo* info  )
{
    ...
    if(define_enum) {
        ...
        type_name_25=(char*)come_increment_ref_count(parse_word((_Bool)0,info));
        __result_obj__0 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value0=parse_enum((char*)come_increment_ref_count(type_name_25),(char*)come_increment_ref_count(struct_attribute),info,(_Bool)0))));
        (struct_attribute = come_decrement_ref_count(struct_attribute, (void*)0, (void*)0, 0, 0, (void*)0));
        (type_name_25 = come_decrement_ref_count(type_name_25, (void*)0, (void*)0, 0, 0, (void*)0));
        ((__right_value0) ? __right_value0 = come_decrement_ref_count(__right_value0, ((struct sNode*)__right_value0)->finalize, ((struct sNode*)__right_value0)->_protocol_obj, 1, 0,(void*)0):(void*)0);
        neo_current_frame = fr.prev;
        ((__result_obj__0) ? __result_obj__0 = come_decrement_ref_count(__result_obj__0, ((struct sNode*)__result_obj__0)->finalize, ((struct sNode*)__result_obj__0)->_protocol_obj, 0, 1,(void*)0):(void*)0);
        return __result_obj__0;
